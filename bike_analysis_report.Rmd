...
data.frame(
  ...
  Description = c("Date-time of observation, hourly",
                  ...
                  "Category field, meteorological season - 0 spring, 1 summer, 2 fall, 3 winter")) %>%
...
The dataset includes five features relating to the weather. Weather varies with the season of the year. However, all else equal, we would still expect bike demand to rise with good weather and fall with bad weather.

The grid of scatterplots below show how bike demand varies with each of the five weather features in the dataset. We see that 

COULD DO THE SCATTERPLOTS CONDITIONING ON SEASON OR MONTH? 5 rows and 4 cols, facet wrap?

```{r}
print("Array of scatterplots")
```
